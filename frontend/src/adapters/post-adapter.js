...
export const createPost = async ({ user_id, title, image, location, description, endTime, startTime, cords }) => {
    return fetchHandler(`/api/users/${user_id}/posts`, getPostOptions({ title, image, location, description, endTime, startTime, cords}))
}
