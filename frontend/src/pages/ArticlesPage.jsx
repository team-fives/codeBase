...
export default function ArticlesPage() {
  ...
  return (
    <>
      <div style={{ position: 'absolute', top: "-80rem", right: "-30rem", zIndex: -1, width: '100%', height: 'auto' }}>
  ...
  whileInView={{ y: [0, -20, 0, -20, 0], transition: { duration: 2, ease: 'easeInOut' } }}
>
  <img src={globeImage} alt="globe image" style={{ width: '35rem', height: 'auto' }} />
</motion.div>


      <motion.div style={{ position: 'absolute', top: '-25rem', left: '2rem', zIndex: 2,width: '50%' }}
